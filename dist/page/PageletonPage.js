...
var PageletonPage = (function () {
    ...
    PageletonPage.prototype.getComponent = function () {
        ...
        var PageComponentType = PageComponentTypeRegistry_1.default.getComponentType(componentSpec.type);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        rootComponents = ComponentSpecService_1.default.getRootElementNodes(this.currentPage.rootComponents);
